...
<img class="only-day" src="/assets/docs/signing-architecture.svg" alt="External signing architecture" />
<img class="only-night" src="/assets/docs/signing-architecture-dark.svg" alt="External signing architecture" />
