...
EU Battery Regulation 2023/1542 Digital Battery Passport on **Midnight**. One dataset, a different view per audience: consumer, recycler, authority. Sensitive numbers like "recycled cobalt share is at least the legal minimum" are **proven without revealing the value**. Only a payload hash and public metadata go on-chain. Everything else stays encrypted off-chain. NIGHTPASS is the shielded twin of DAYPASS on Cardano and is built on [`@odatano/nightgate`](https://github.com/ODATANO/NIGHTGATE).
