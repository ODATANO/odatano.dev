...
Full-stack SAP Fiori app that reads and writes Cardano through ODATANO. Tracks pharmaceutical batches from manufacturer to distributor to pharmacy, with **NFTs as on-chain proof** and **CIP-30 browser wallet signing**.
