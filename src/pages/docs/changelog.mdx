...
Release candidate of the 2.0 line, published as npm `latest` — a plain `npm i @odatano/core` installs it. `^2.0.0` does not match a pre-release, so pin `@odatano/core@2.0.0-rc.1`; to stay on 1.x pin `@odatano/core@^1.11.0`.
