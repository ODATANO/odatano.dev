...
**Version:** v0.3.1-milestone3\
**Status:** Production-Ready -- OData V4 read service + transaction building + external signing with multi-provider failover (v1.0 coming soon)
