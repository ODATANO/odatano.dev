...
- **AI agents:** [`@odatano/nightgate-mcp`](/docs/nightgate-mcp/) exposes the attestation layer (anchor, prove, verify, grant) as MCP tools — scoped by `ngat_…` agent-grant tokens
