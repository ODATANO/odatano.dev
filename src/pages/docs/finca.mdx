...
description: Verifiable anchoring of accounting and financial-report data on Cardano. Full SAP Fiori reference app built on ODATANO.
---

# FINCA Example App

Full-stack SAP Fiori app that anchors **financial data** on Cardano through ODATANO. FINCA (Financial Data Anchoring) manages organisations, journal transactions and financial reports. It anchors them on-chain as **CIP-10 label-1447 metadata** following the Cardano Foundation's [Reeve](https://github.com/cardano-foundation/cf-reeve-platform) specification. Verifiable accounting without a smart contract.
